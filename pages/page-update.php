<?php
	define('const_update_custom_fields', 3);
...
?>
				...
				foreach ($detailshistory['@file'] as $txid => $string) {
					...
					if (is_array($fileref)) {
						...
						echo '<a href="./download-file?txid='.html($txid).'&vout='.html($fileref['vout']).'">'.
...
?>
				...
				<div class="col-sm-8">
					...
					<form class="form-horizontal" method="post" enctype="multipart/form-data" action="./?page=<?php echo html($_GET['page'])?>">
