...
?>
				...
				if ($cansetlabel)
					...
					'<a href="'.chain_page_url_html('label', array('address' => $address)).'">'.
...
?>
					...
					echo ' &ndash; <a href="'.chain_page_url_html('permissions', array('address' => $address)).'">change</a>';
...
?>
					<form class="form-horizontal" method="post" action="<?php echo chain_page_url_html()?>">
